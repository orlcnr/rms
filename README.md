...
## rms/docker
- Docker ve altyapı konfigürasyonları burada yer alır
- Container'lar arası iletişim buradan yönetilir
- Application code YOKTUR

## frontend
- Frontend uygulaması (framework belirt)
- Sadece UI ve API çağrıları yapılır
- Backend logic yazılmaz

## backend
- API ve business logic burada yer alır
- Frontend ile sadece HTTP ve socket.io üzerinden iletişim kurulur
