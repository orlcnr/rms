...
export class AddCustomerDebtFields1739999999999 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX IF EXISTS "idx_customers_current_debt"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "idx_payments_customer_id"`);
    
    await queryRunner.query(`ALTER TABLE "operations"."payments" DROP COLUMN IF EXISTS "original_payment_id"`);
    await queryRunner.query(`ALTER TABLE "operations"."payments" DROP COLUMN IF EXISTS "discount_reason"`);
    await queryRunner.query(`ALTER TABLE "operations"."payments" DROP COLUMN IF EXISTS "discount_type"`);
    await queryRunner.query(`ALTER TABLE "operations"."payments" DROP COLUMN IF EXISTS "change_given"`);
    await queryRunner.query(`ALTER TABLE "operations"."payments" DROP COLUMN IF EXISTS "cash_received"`);
    await queryRunner.query(`ALTER TABLE "operations"."payments" DROP COLUMN IF EXISTS "customer_id"`);
    
    await queryRunner.query(`ALTER TABLE "business"."customers" DROP COLUMN IF EXISTS "max_open_orders"`);
    await queryRunner.query(`ALTER TABLE "business"."customers" DROP COLUMN IF EXISTS "credit_limit_enabled"`);
    await queryRunner.query(`ALTER TABLE "business"."customers" DROP COLUMN IF EXISTS "credit_limit"`);
    await queryRunner.query(`ALTER TABLE "business"."customers" DROP COLUMN IF EXISTS "current_debt"`);
    await queryRunner.query(`ALTER TABLE "business"."customers" DROP COLUMN IF EXISTS "total_debt"`);
  }
}
