...
export function CategoryTabs({ categories, activeCategoryId, onCategoryChange, onAddCategory }: CategoryTabsProps) {
    return (
        <div className="flex items-center gap-2 overflow-x-auto pb-2 scrollbar-hide">
            ...
            <button
                ...
                title="YENİ KATEGORİ TANIMLA"
            >
                <Plus size={14} className="group-hover:rotate-90 transition-transform" />
                <span className="text-[9px] font-black uppercase tracking-[0.1em]">KATEGORİ EKLE</span>
            </button>
        </div>
    )
}
