...
export function CashCloseModal({
  ...
  return (
    <Modal
      ...
      maxWidth="max-w-5xl"
    >
      <div className="bg-bg-surface rounded-sm border border-border-light p-6 w-full max-h-[90vh] overflow-y-auto">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 xl:grid-cols-[minmax(0,340px)_minmax(0,1fr)] gap-6">
          <div className="space-y-4">
            {/* Personel Bahşiş Uyarısı */}
            {cardTipsToday > 0 && (
              <div className="p-4 bg-primary-main/10 border border-primary-main/30 rounded-sm">
                <div className="flex items-start gap-3">
